<div class="offcanvas offcanvas-start mobile-sidebar" tabindex="-1" id="mobileSidebar"
    ...
    <div class="mb-7 text-center">
        <svg width="85" height="113" viewBox="0 0 85 113" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_7_511)">
                ...
                <path
                    d="M81.6532 33.2783L80.3236 57.0485L71.0626 58.0085L66.2486 45.6205L65.6068 58.0999h37.5378L58.1338 33.0955L66.5237 32.9126L66.9822 32.6841L73.034 43.7006L73.2632 34.0097L73.3091 33.5069L81.6532 33.2783Z"
                    fill="#BA9D9D" />
                <path
                ...
                <path
                    d="M81.6532 63.0368L80.3236 86.807L71.0626 87.767L66.2486 75.379L65.6068 87.8584h37.5378L58.1338 62.7168H66.5237H67.028L73.034 73.4591L73.3091 63.2654L81.6532 63.0368Z"
                    fill="#8DFFC8" />
                <path
                    d="M22.3274 44.9806L29.5254 57.3685L21.2729 58.8313L16.0464 51.4259L15.6796 59.2884L8.34413 59.3798L8.57337 32.4098L16.9175 33.0954L16.5507 41.0493L21.9606 32.6383L30.534 33.4154L22.3274 44.9806Z"
                    fill="#8DFFC8" />
    ...
    <div class="offcanvas-body">
        <ul class="nav flex-column">
            <li class="nav-item mb-3">
                <a class="nav-link {{ Route::is('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}"><i class="fas fa-home me-2"></i>Accueil</a>
            </li>
            <li class="nav-item mb-3">
    ...
    <div class="sidebar-footer mt-auto pt-4 border-top">
        <div class="d-flex align-items-center mb-2">
            <img src="{{ Auth::user()->avatar }}" alt="Avatar" class="rounded-circle me-2" width="40"
                height="40" />
            <div>

...
@section('content')
    <div class="notfound-container">
        <div class="floating-elements">
            <div class="floating-bubble" style="left: 10%; width: 20px; height: 20px; animation-delay: 0s;"></div>
            <div class="floating-bubble" style="left: 20%; width: 15px; height: 15px; animation-delay: 2s;"></div>
            <div class="floating-bubble" style="left: 70%; width: 25px; height: 25px; animation-delay: 4s;"></div>
            <div class="floating-bubble" style="left: 80%; width: 18px; height: 18px; animation-delay: 6s;"></div>
            <div class="floating-bubble" style="left: 90%; width: 22px; height: 22px; animation-delay: 8s;"></div>
        </div>

        <div class="notfound-card-container">
            ...
            <p>Comme un chaussette qui disparaît dans la machine, cette page est introuvable. Mais ne vous inquiétez
                pas, Klinklin est toujours là pour vous !</p>

            <div class="service-icons">
                <div class="service-icon">
                    <div class="icon-circle">🏠</div>
                    <div class="icon-text">Collecte</div>
                </div>
                <div class="service-icon">
                    <div class="icon-circle">🧺</div>
                    <div class="icon-text">Lavage</div>
                </div>
                <div class="service-icon">
                    <div class="icon-circle">🚚</div>
                    <div class="icon-text">Livraison</div>
                </div>
            </div>
        </div>
    </div>

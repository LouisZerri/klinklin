    ...
    <div class="login-right">
        ...
        >
            <g clip-path="url(#clip0_7_511)">
                <path
                    d="M73.2632 34.0097V33.6897L76.6101 33.4155L73.2632 34.0097Z"
                    fill="#C10606"
                />
                <path
                ...
                />
                <path
                    d="M54.3744 57.6885L46.9013 58.0085V34.1926L56.4375 33.7354L54.3744 57.6885Z"
                    fill="#BA9D9D"
                />
                <path
                ...
                />
                <path
                    d="M54.3744 87.447L46.9013 87.767V63.951L56.4375 63.4939L54.3744 87.447Z"
                    fill="#8DFFC8"
                />
                <path

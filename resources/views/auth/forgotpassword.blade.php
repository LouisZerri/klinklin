...
<div class="reset-container">
    <div class="reset-card">
        ...
        <p class="instructions">
            Entrez l’adresse mail associée à votre compte et nous vous
            enverrons<br />
            un lien afin de restaurer votre mot de passe.
        </p>

        <form method="POST" action="{{ route('post_sendresetlink') }}">
            @csrf

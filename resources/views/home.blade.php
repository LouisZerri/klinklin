...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-6 position-relative">
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3 hero-buttons">
                        <a href="{{ route('collecte') }}" class="btn btn-purple">Planifier une collecte</a>
        ...
        <div class="container">
            ...
            <div class="cards-grid">
                <div class="card">
                    ...
                    <a href="{{ route('feature', 'collecte-de-vetements') }}" class="card-link">En savoir plus →</a>
                </div>
                ...
                <div class="card card-highlight">
                    ...
                    <a href="{{ route('feature', 'lavage-professionnel') }}" class="card-link dark">En savoir plus →</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="{{ route('feature', 'livraison-rapide') }}" class="card-link">En savoir plus →</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="{{ route('feature', 'paiement-securise') }}" class="card-link">En savoir plus →</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="{{ route('feature', 'option-abonnement') }}" class="card-link">En savoir plus →</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="{{ route('feature', 'produits-respectueux') }}" class="card-link">En savoir plus →</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <blog-carousel :posts="{{ json_encode($blogPosts) }}"></blog-carousel>
    ...
    <section class="cta-section">
        <div class="cta-content">
            ...
            <div class="cta-buttons">
                <a href="{{ route('collecte') }}" class="btn btn-collecte">
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <p>
                Copyright © 2025 KLIN KLIN. Tous droits réservés.
            </p>

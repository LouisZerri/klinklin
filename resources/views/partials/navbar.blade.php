        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <ul class="navbar-nav mx-auto gap-4 align-items-center">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}#ccm">Comment ça marche ?</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}#avantage">Nos Avantages</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}#temoignages">Témoignages</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="{{ route('home') }}#blog">Blog</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('home') }}#faq">FAQ</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('help') }}">Centre d'aide</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}" class="btn btn-purple">Mon espace</a>
                    @else
